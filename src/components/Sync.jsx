...
const Sync = () => {
  ...
  const cards = document.querySelector('.gsap-cards')
  ...
  useEffect(() => {
    ...
    gsap.to(".gsap-cards", {
      ...
      scrollTrigger: {
        ...
        start: "top center",
        end: () => "+=" + (cards.scrollWidth * 1.5), // 👈 Dynamic end point
        scrub: 1,
        pin: true,
        invalidateOnRefresh: true, // Responsive ke liye important
        markers: true, // Position debug karein
      pinSpacing: false // 👈 Extra space hatane ke liye
      }
    })
  ...
  return (
    <div className='gsap-section w-full px-4 lg:px-[5vw] py-10 lg:py-15 bg-black overflow-x-hidden min-h-[60vh]'>
      ...
      <div className='gsap-cards flex items-center gap-10 lg:gap-6 mt-10 lg:w-[100vw] w-[300vw] '>
