  ...
  return (
    <div className='gsap-section w-full px-4 lg:px-[5vw] py-10 lg:py-15 bg-black overflow-x-hidden'>
      ...
      <div className='gsap-cards flex items-center gap-10 lg:gap-15 lg:px-14  mt-10 lg:w-[100vw] w-[500vw]'>
        <div className='card w-[93vw] md:w-[50vw] md:h-[60vw] h-[90vw] border border-white flex items-center flex-shrink-0 justify-center  rounded-[3vw] border-none bg-[#1263CD] lg:w-[28vw] lg:h-[35vw] lg:rounded-[1vw]'>
          <img className='w-[60vw] h-[80vw] md:w-[44vw] md:h-[60vw] lg:rounded-[0vw] lg:w-[37vw] lg:h-full object-cover' src="https://www.ayusynk.ai/wp-content/uploads/2024/08/st-a2.png" alt="" />
